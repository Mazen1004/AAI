...
OPENAIAPI_PROMPT_TEMPLATE = (
    ...
    "Please analyze the image and provide details about the artifact. What time period it came from, a funfact about it and any interesting info. "
)
