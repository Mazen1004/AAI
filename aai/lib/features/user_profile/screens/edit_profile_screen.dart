...
import 'package:aai/core/common/error_text.dart';
...
import 'package:aai/features/user_profile/controller/user_profile_controller.dart';
import 'package:aai/responsive/responsive.dart';
...
class _EditProfileScreenState extends ConsumerState<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ref.watch(getUserDataProvider(widget.uid)).when(
          data: (user) => Scaffold(
            backgroundColor: Pallete.darkModeAppTheme.drawerTheme.backgroundColor,
            appBar: AppBar(
